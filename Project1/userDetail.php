            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png") {
                if ($fileSize >= 0 && $fileSize <= 1000000) {
                    ...
                    if ($result == true) {
                        ...
                        header("Location:" . SITE_URL . "/PHPOPS/Day19/Assignments/Project1/userDetail.php");
                    } else {
...
$leftProfile = "<div class='card'>
                <div class='card-body profile-card pt-4 d-flex flex-column align-items-center'>
                    <img src='" . SITE_URL . "PHPOPS/Day19/Assignments/Project1/admin/assets/img/upload/" . $result[0]['emp_Id'] . "/" . $result[0]['profile_Pic'] . "' alt='Profile' class='rounded-circle w-50'>
...
<input class="form-check-input sts" type="checkbox" data-empid="' . $result[0]['emp_Id'] . '" role="switch" id="sts' . $result[0]['emp_Id'] . '" checked>
</div>';
} else {
    $status = '<div class="form-check form-switch">
<input class="form-check-input sts" type="checkbox" data-empid="' . $result[0]['emp_Id'] . '" role="switch" id="sts' . $result[0]['emp_Id'] . '">
</div>';
}
?>
                ...
                <div class="card">
                    <div class="card-body pt-3">
                        <ul class="nav nav-tabs nav-tabs-bordered">
                            ...
                            <li class="nav-item">
                                <button class="nav-link"><?php echo $status; ?></button>
                            </li>
                        </ul>
                                    ...
                                    <div class="row justify-content-center align-items-center g-2">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-select" id="state" name="state" required>
                                                <?php
                                                if (isset($_SESSION['userEmail'])) {
                                                    echo "<option value='" . $result[0]['state'] . "' selected>" . $result[0]['state_Name'] . "</option>";
                                                } else {
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-select" id="city" name="city" required>
                                                ...
                                                if (isset($_SESSION['emp_Id'])) {
                                                    echo "<option value='" . $result[0]['city'] . "' selected>" . $result[0]['city_Name'] . "</option>";
                                                } else {
                                                    echo '<option disabled value="" selected>-select-</option>';
                                                }
                                                ?>
                                    ...
                                    <div class="row justify-content-center align-items-center g-2">
                                        ...
                                        <div class="col">
                                            <div class="form-check form-switch d-flex align-self-center align-items-center justify-content-center mt-4 fs-4">
                                                <input class="form-check-input" type="checkbox" role="switch" id="status" name="status" <?php if (isset($_SESSION['emp_Id'])) {
                                                                                                                                            if ($result[0]['status'] == 1) {
                                                                                                                                                echo 'checked';
                                                                                                                                            }
                                                                                                                                        } else {
