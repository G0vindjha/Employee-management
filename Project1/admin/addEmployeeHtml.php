...
<div class="col-10 mb-3">
  <div class="col-12 mt-3 d-flex justify-content-end pe-5">
    <a name="back" id="back" class="btn btn-primary me-5" href="<?php echo SITE_URL; ?>PHPOPS/Day19/Assignments/Project1/admin/employeeList.php" role="button">BACK</a>
  </div>
    ...
    <form class="row g-3 needs-validation" id="validater" novalidate method="post" enctype="multipart/form-data">
      <div class="row justify-content-center align-items-center g-2">
        ...
        <div class="col">
          ...
          <input type="hidden" class="form-control" aria-label="file example" id="profile_Pic_filled" name="profile_Pic_filled" value="<?php if (isset($_GET['emp_Id'])==true){ echo $result[0]['profile_Pic'];}?>">
      ...
      <div class="row justify-content-center align-items-center g-2">
        ...
        <div class="col">
          ...
          <select class="form-select" id="state" name="state" required>
            <?php
            if (isset($_GET['emp_Id'])) {
              echo "<option value='" . $updateResult['state'] . "' selected>" . $updateResult['state_Name'] . "</option>";
            } else {
        ...
        <div class="col">
          ...
          <select class="form-select" id="city" name="city" required>
            <?php
            if (isset($_GET['emp_Id'])) {
              echo "<option value='" . $updateResult['city'] . "' selected>" . $updateResult['city_Name'] . "</option>";
            } else {
              echo '<option disabled value="" selected>-select-</option>';
            }
            ?>
