...
if (isset($_GET['emp_Id'])) {
    ...
    $imgpath = SITE_URL . 'PHPOPS/Day19/Assignments/Project1/admin/assets/img/upload/' . $_GET['emp_Id'] . '/' . $updateResult['profile_Pic'];
            ...
            if ($fileExtension == "jpeg" || $fileExtension == "png") {
                if ($fileSize >= 0 && $fileSize <= 1000000) {
                    ...
                    if ($result == true) {
                        ...
                        header("Location:" . SITE_URL . "/PHPOPS/Day19/Assignments/Project1/admin/employeeList.php");
                    } else {
