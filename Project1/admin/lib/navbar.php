<header id="header" class="header fixed-top d-flex align-items-center position-relative">
  <div class="col-2">
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo SITE_URL; ?>PHPOPS/Day19/Assignments/Project1/admin/index.php" class="logo d-flex align-items-center">
  ...
  <div class="col-4">
    <div class="pagetitle mt-4">
      ...
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="<?php echo SITE_URL; ?>PHPOPS/Day19/Assignments/Project1/admin/index.php">Home</a></li>
